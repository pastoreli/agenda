!function() {
  ...
  Calendar.prototype.drawDay = function(day) {
    ...
    var event_day = getEventos(day.format('DD'), mes, ano);
...
function criarEventos(){
  eventos = [
    ...
    { hour: '11:30', dia: 9, mes: 9, Ano: 2017, descricao: 'Pintar de roxo unha da Luana', categoria: 0 },
...
function getCategoria(index){
   ...
   var legendas = [
    ...
    {categoria: 'Pacote', color: 'green water'},
